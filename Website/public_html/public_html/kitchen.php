...
if (isset($_GET['search'])) {
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM datasensorkitchen where
   id        LIKE '%$keyword%' OR
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM datasensorkitchen");
}
   ...
   <div class="grid-container">
      ...
      <main class="main-container">
         <div class="main-title">
            <p class="font-weight-bold" style="text-align: center;">DATABASE KITCHEN</p>
         ...
         <?php
         $koneksi = mysqli_connect("localhost", "id20835178_mrnyahya", "Yaya12345*", "id20835178_datalogging");
         $result = $koneksi->query("SELECT * FROM datasensorkitchen");
         ?>
         <!-- Isi -->
                  ...
                  <tbody>
                     ...
                     <?php foreach ($query as $data) : ?>
                        <tr>
                           ...
                           <td><a class="bi bi-trash" style="text-align: center; color: #6a9792; font-size: 25px" href="hapus_kitchen.php?id=<?php echo $data["id"]; ?> "></a></td>
                        </tr>
                        <?php $y++; ?>
                     <?php endforeach; ?>
                  </tbody>
